...
using DehkadehAmoozesh.BasicInfo.API.Core.Domain.Aggregate.Tickets.Events;
...
namespace DehkadehAmoozesh.BasicInfo.API.Core.Domain.Aggregate.Tickets.Entities
{
